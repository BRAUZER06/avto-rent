...
import style from "./AdsCardScrollClient.module.scss";
...
export const AdsCardScrollClient = memo(({ ads, isOwner = false, onDeleted }: Props) => {
    ...
    return (
        <div className={style.container}>
            <Link href={`/client/${ads?.owner?.company_name}/car/${slug}`}>
                <Swiper
                    spaceBetween={10}
                    slidesPerView="auto"
                    freeMode
            ...
            <div className={style.infoBlock}>
                <div className={style.mainInfo}>
                    <Link
                        href={`/client/${ads?.owner?.company_name}/car/${slug}`}
