...
export const ProfileRedactAuto = ({ initialData }) => {
    ...
    useEffect(() => {
        if (initialData) {
            ...
            setPricePerDay(initialData.pricePerDay || "");
            setCategory(initialData.category || "premium");
            setCustomFields(initialData.customFields || []);
            setFuel(initialData.fuel || "бензин");
            setDrive(initialData.drive || "задний");
            setHorsepower(initialData.horsepower || "");
            setImages(
