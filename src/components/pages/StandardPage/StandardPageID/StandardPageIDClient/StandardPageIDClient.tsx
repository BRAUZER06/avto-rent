...
import style from "./StandardPageIDClient.module.scss";
...
import { RightPriceBlockClient } from "@src/components/RightPriceBlock/RightPriceBlockClient/RightPriceBlockClient";
import SimilarCategoryCtaAdsClient from "@src/components/ui/SimilarCategoryCtaAds/SimilarCategoryCtaAdsClient/SimilarCategoryCtaAdsClient";
...
export default function StandardPageIDClient({ car, region }: { car: Car; region?: string }) {
    ...
    return (
        <div className={style.container}>
            <div className={style.leftBlock}>
                ...
                <div className={style.margin}>
                    <SimilarCategoryCtaAdsClient owner={car?.owner} />
                </div>
            </div>

            <div className={style.rightBlock}>
                <RightPriceBlockClient
                    price={car?.price}
                    contacts={car?.contacts}
