...
import style from "./RightPriceBlockClient.module.scss";
...
interface RightPriceBlockClientProps {
    price?: string | number;
...
export const RightPriceBlockClient = ({
    price,
    contacts,
    customFields,
    owner,
}: RightPriceBlockClientProps) => {
    ...
    const brandHref = owner?.company_name
        ? `/client/${encodeURIComponent(String(owner?.company_name))}`
        : undefined;
